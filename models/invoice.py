...
#                lines['RUTMandante']
    ...
    @api.one
    def numero_to_letras(self):
        numero = self.amount_total
        ...
        _logger.info(numero_letras)
        numero_letras = numero_letras+" con " + str(decimal) +"/100"
        print 'numero: ',numero
        print numero_letras
        self.amount_letter = numero_letras
    ...
    def convierte_cifra(self,numero,sw):
        ...
        _logger.info("%s %s %s" %(texto_centena,texto_decena,texto_unidad))
